...
from .views import BlockIp, CategoryActive, GoogleLogin, HostelViewSet, InventoryViewSet, ItemActive, LoginView, MealItemView, MealViewSet, ModifyOrder, NoticeViewSet, OrderCompleteView, OrderCreateView, OrderHistory, PaymentViewSet, ProductViewSet, ProductquantityViewSet, Record_payment, RestorantDetails, RestorantViewSet, RoomViewSet, SetManagerHostel, SetManagerRestorant, SignupView, StudentViewSet, TableDetail, TableViewSet, CategoryViewSet, ItemViewSet, OrderViewSet, OrderDetailViewSet, Userdata, VerifyOTPView, DataAnalysis
