...
from .views import LoginView, OrderCompleteView, OrderCreateView, Record_payment, RestorantViewSet, SignupView, TableViewSet, CategoryViewSet, ItemViewSet, OrderViewSet, OrderDetailViewSet, Userdata, VerifyOTPView
